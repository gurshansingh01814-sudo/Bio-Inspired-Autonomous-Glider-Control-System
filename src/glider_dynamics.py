...
class MPCController:
    ...
    def __init__(self, config_path):
        ...
        # Using epsilon^2 in calculations below for better gradient behavior near zero.
    ...
    def _glider_dynamics(self, X, U, W_atm_z):
        ...
        CRITICAL CHANGE: Uses norm-squared regularization (epsilon^2) 
        for robust unit vector calculation to prevent NaN issues in the Jacobian.
        """
        ...
        # Using epsilon^2 inside the square root for a smoother gradient near zero.
        ...
        # Uses norm-squared regularization for smoother gradient of L_vert_unit near zero.
    ...
    def solve_mpc(self, initial_state, thermal_center, Wz_prediction):
        ...
        try:
            ...
            # The simulator will print this fallback control command.
